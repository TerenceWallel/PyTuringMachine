...
if __name__ == '__main__':
    ...
    graphDict[('q1', '0')] = ('q2', '#', R)
    graphDict[('q2', '#')] = ('qaccept', '#', R)
    graphDict[('q2', 'x')] = ('q2', 'x', R)
    graphDict[('q2', '0')] = ('q3', 'x', R)
    graphDict[('q3', 'x')] = ('q3', 'x', R)
    graphDict[('q3', '#')] = ('q5', '#', L)
    graphDict[('q3', '0')] = ('q4', '0', R)
    graphDict[('q4', '0')] = ('q3', 'x', R)
    graphDict[('q4', 'x')] = ('q4', 'x', R)
    graphDict[('q5', 'x')] = ('q5', 'x', L)
    graphDict[('q5', '0')] = ('q5', '0', L)
    graphDict[('q5', '#')] = ('q2', '#', R)
    # 生成状态集与带子字母表
    # 初始状态集
    ...
    AG.layout('dot')
    # 生成png图
    AG.draw('Experiment1.png')
    AG.draw('Experiment1.pdf')

    # 显示图片
    image = plt.imread('Experiment1.png')
    plt.imshow(image)
    plt.show()
